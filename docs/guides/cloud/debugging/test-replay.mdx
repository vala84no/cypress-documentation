...
This can positively affect test speed without loosing the interactive benefit of the command log during the Test Replay. You can still keep the command log enabled for tests run in non-Chromium browsers to keep its benefit in your test artifacts.
